...
Chat.getLayout = (page: ReactNode) => <DashboardLayout>{page}</DashboardLayout>;
	...
	return (
		<>
			<div className="flex md:flex-row flex-col gap-5 md:h-[calc(100vh-120px h-screen">
				<div
					className="flex flex-col md:h-full h-1/2 w-full items-center justify-center bg-black rounded-2xl border border-solid border-success">
					...
					<div className="md:w-80 w-full h-screen bg-black text-base-content overflow-y-auto">
